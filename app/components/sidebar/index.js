...
const Sidebar = props => {
    ...
    const { parent, header, buttonContainer, button } = Styles;
    const routes = [{
        title: 'Home',
        route: 'home'
    }, {
